...
const PixelMusicPlayer = () => {
  ...
  const PlayIcon = () => <svg width="20" height="20" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" fill="currentColor"/></svg>;
  const PauseIcon = () => <svg width="20" height="20" viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" fill="currentColor"/></svg>;
  const PrevIcon = () => <svg width="16" height="16" viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z" fill="currentColor"/></svg>;
  const NextIcon = () => <svg width="16" height="16" viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z" fill="currentColor"/></svg>;
  const VolumeIcon = () => <svg width="18" height="18" viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z" fill="currentColor"/></svg>;
  ...
  return (
    <div className="pixel-player-container">
      <style>{`
        ...
        /* UPDATED: Scroll Keyframes for seamless looping */
        @keyframes scroll { 
        ...
        /* UPDATED: Wrapper logic for continuous scroll */
        .led-text-wrapper {
          display: flex; /* Keeps duplicates in a row */
          white-space: nowrap;
          position: absolute;
          left: 0;
          /* Continuous slide: moves half its width (one full text copy) */
        ...
        .pixel-btn.primary { width: 52px; height: 52px; background: #5DE2E7; color: #1E1C38; }
        .pixel-btn.secondary { width: 40px; height: 40px; background: #A5A6C5; }
      ...
      <div className="player-card">
        ...
        <div className="controls">
          <div className="btn-group">
            <button className="pixel-btn secondary" onClick={prevTrack}><PrevIcon /></button>
            <button className="pixel-btn primary" onClick={togglePlay}>
              {isPlaying ? <PauseIcon /> : <PlayIcon />}
            </button>
            <button className="pixel-btn secondary" onClick={nextTrack}><NextIcon /></button>
          </div>
